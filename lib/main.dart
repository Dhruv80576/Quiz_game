...
class _HomePageState extends State<HomePage> {
  ...
  void _getData() async {
    ...
    for (var i in temp) {
      ...
      ques_dtl_lst.add(
          Question_model(i.question, a, i.level, i.answer_indx, Colors.white));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          slivers: [
                                      ...
                                      onPressed: () {
                                        if (esy_ques >= quiz_ques_nmbr) {
                                          ...
                                          ScaffoldMessenger.of(context)
                                              ...
                                              content: Text(
                                                  "Add ${quiz_ques_nmbr -
                                                      esy_ques} easy level questions to continue.")));
                                        }
                                      },
                                        ...
                                        onPressed: () {
                                          if (mdm_ques >= quiz_ques_nmbr) {
                                            ...
                                            ScaffoldMessenger.of(context)
                                                ...
                                                content: Text(
                                                    "Add ${quiz_ques_nmbr -
                                                        mdm_ques} medium level questions to continue.")));
                                          }
                                        },
                                        child: Text("MEDIUM")),
                                    ElevatedButton(
                                        onPressed: () {
                                          if (hrd_ques >= quiz_ques_nmbr) {
                                            ...
                                            ScaffoldMessenger.of(context)
                                                ...
                                                content: Text(
                                                    "Add ${quiz_ques_nmbr -
                                                        hrd_ques} hard level questions to continue.")));
                                          }
                                        },
                                        child: Text("HARD")),
                                  ],
            ...
            SliverList(
                delegate: SliverChildBuilderDelegate(
                  childCount: ques_dtl_lst.length == 0 ? 1 : ques_dtl_lst
                      .length,
                      (context, index) {
        ...
        floatingActionButton:role!="Teacher"?Text(''):FloatingActionButton(
      onPressed: () {
        // setState(() {
        //   ques_dtl_lst
